...
NEW OPTIMAL APPROACH:
    ...
    - Store the number of occurences in a hashmap for each element
    - Add each of those occurences into a frequency array (frequency bucket)
    - Return the k results from the array, moving backwards
